/* @ts-self-types="./towers.d.ts" */

export class VisualPreview {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(VisualPreview.prototype);
        obj.__wbg_ptr = ptr;
        VisualPreviewFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        VisualPreviewFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_visualpreview_free(ptr, 0);
    }
    /**
     * List all Visual IDs in RON text. Returns JSON object with "ids" and "errors" arrays.
     * @param {string} ron_text
     * @returns {string}
     */
    list_visuals(ron_text) {
        let deferred2_0;
        let deferred2_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(ron_text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.visualpreview_list_visuals(retptr, this.__wbg_ptr, ptr0, len0);
     ...
     * Async: WebGPU adapter/device initialization requires await.
     * @param {HTMLCanvasElement} canvas
     * @param {boolean} has_webgpu
     */
    constructor(canvas, has_webgpu) {
        const ret = wasm.visualpreview_new(addHeapObject(canvas), has_webgpu);
     ...
     */
    pan(dx, dy) {
        wasm.visualpreview_pan(this.__wbg_ptr, dx, dy);
    }
    /**
     * Render one frame using the real wgpu SDF pipeline.
     * @param {number} time_seconds
     */
    render_frame(time_seconds) {
        wasm.visualpreview_render_frame(this.__wbg_ptr, time_seconds);
    }
    /**
     * Reset camera to default view.
     */
    reset_camera() {
        wasm.visualpreview_reset_camera(this.__wbg_ptr);
    }
    /**
     ...
     */
    resize(width, height) {
        wasm.visualpreview_resize(this.__wbg_ptr, width, height);
    }
    /**
     ...
     */
    set_camera(x, y, zoom) {
        wasm.visualpreview_set_camera(this.__wbg_ptr, x, y, zoom);
    }
    /**
     * Re-compile from new RON text (last Visual — typically the top-level scene).
     * Returns warnings as JSON array string.
     * @param {string} ron_text
     * @returns {string}
     */
    update(ron_text) {
        ...
        try {
            ...
            const ptr0 = passStringToWasm0(ron_text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.visualpreview_update(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred2_0 = r0;
            deferred2_1 = r1;
    ...
    /**
     * Compile a specific Visual by ID. Returns warnings as JSON array string.
     * @param {string} ron_text
     * @param {string} visual_id
     * @returns {string}
     */
    update_by_id(ron_text, visual_id) {
        let deferred3_0;
        let deferred3_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(ron_text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(visual_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len1 = WASM_VECTOR_LEN;
            wasm.visualpreview_update_by_id(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred3_0 = r0;
            deferred3_1 = r1;
    ...
    /**
     * Zoom at a screen point (keeps that point stationary).
     * @param {number} factor
     * @param {number} screen_x
     * @param {number} screen_y
     */
    zoom_at(factor, screen_x, screen_y) {
        wasm.visualpreview_zoom_at(this.__wbg_ptr, factor, screen_x, screen_y);
    }
}
if (Symbol.dispose) VisualPreview.prototype[Symbol.dispose] = VisualPreview.prototype.free;

/**
 * Get the isometric depth sort key for a world point with the given rotation.
 * @param {number} world_x
 * @param {number} world_y
 * @param {number} rotation
 * @returns {number}
 */
export function iso_depth_key(world_x, world_y, rotation) {
    const ret = wasm.iso_depth_key(world_x, world_y, rotation);
    return ret;
}

/**
 * Inverse isometric projection: screen → world, with rotation.
 * Returns [world_x, world_y] or empty vec if no inverse.
 * @param {number} screen_x
 * @param {number} screen_y
 * @param {number} tile_w
 * @param {number} tile_h
 ...
 */
export function iso_screen_to_world(screen_x, screen_y, tile_w, tile_h, rotation) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.iso_screen_to_world(retptr, screen_x, screen_y, tile_w, tile_h, rotation);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
/**
 * Project a world point using isometric projection with the given rotation.
 ...
 */
export function iso_world_to_screen(world_x, world_y, tile_w, tile_h, rotation) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.iso_world_to_screen(retptr, world_x, world_y, tile_w, tile_h, rotation);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
/**
 * Wasm-exposed function: takes JSON array of {path, content} objects,
 * returns JSON object with entries and diagnostics.
 * @param {string} files_json
 * @returns {string}
 */
export function parse_ron_files_json(files_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.parse_ron_files_json(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
/**
 * Get the top-down depth sort key for a world point.
 * @param {number} world_x
 * @param {number} world_y
 * @returns {number}
 */
export function td_depth_key(world_x, world_y) {
    const ret = wasm.td_depth_key(world_x, world_y);
    return ret;
}

/**
 * Project a world point using top-down projection.
 * Returns [screen_x, screen_y].
 * @param {number} world_x
 * @param {number} world_y
 ...
 * @returns {Float32Array}
 */
export function td_world_to_screen(world_x, world_y, unit_scale) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.td_world_to_screen(retptr, world_x, world_y, unit_scale);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v1 = getArrayF32FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export4(r0, r1 * 4, 4);
 ...
 */
export function tick(timestamp_ms) {
    wasm.tick(timestamp_ms);
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_aaaeaf29cf802876: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_6912(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbg_visualpreview_new: function(arg0) {
            const ret = VisualPreview.__wrap(arg0);
            return addHeapObject(ret);
        },
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_1369, __wasm_bindgen_func_elem_1370);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_2431, __wasm_bindgen_func_elem_2432);
            return addHeapObject(ret);
        },
    ...
    return {
        __proto__: null,
        "./towers_bg.js": import0,
    };
}

function __wasm_bindgen_func_elem_1370(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_1370(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_2432(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_2432(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_6912(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_6912(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
const VisualPreviewFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_visualpreview_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('towers_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
